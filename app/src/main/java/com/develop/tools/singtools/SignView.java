package com.develop.tools.singtools;
...
public class SignView extends View {
    ...
    private static final int COLOR_MARKER_WEEKEND = 0xFFe74c3c;
    /**
     * 已签到背景色
     */
    private static final int COLOR_BACKGROUND_HIGHLIGHT = 0xFFe74c3c;
    /**
     * 未签到背景色
     */
